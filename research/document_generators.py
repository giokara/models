...
def imdb_documents(dataset='train',
  ...
  tf.compat.v1.logging.info('Generating IMDB documents...')
...
def rcv1_documents(dataset='train',
  ...
  tf.compat.v1.logging.info('Generating rcv1 documents...')
...
def rt_documents(dataset='train',
  ...
  tf.compat.v1.logging.info('Generating rt documents...')
